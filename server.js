...
function createNewAnimal(body, animalsArray) {
  const animal = body;
  // push the added information to the animalArray
  animalsArray.push(animal);
  // writes info to the animals.json file
  fs.writeFileSync(
...
// function to validate animal info
...
app.post('/api/animals', (req, res) => {
  // set id based on what the next index of the array wil be; this method will cause issues if there is any information that needs to be deleted in the future
